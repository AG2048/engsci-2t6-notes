...
\item The Chain Rule:
	...
	\begin{example}
		...
		\end{equation}
		From this, expanding to the 3 dimensions so we can try solving using the old fashioned method of subbing in each variable
		\begin{align*}
			\ell &=  2+3t \\
			h &= 3-2t \\
			d &=  4+5t \\
...
\item \textbf{Implicit Differentiation:}
	\[
	u\left( x,y \right) = 0 \implies \frac{dy}{dx} = 0
	.\] 
	Let $x = t$, $y = y\left( t \right) $, Then we have $u = u\left( t,y\left( t \right)  \right) $ because we chose $x=t$, so $y$ must be a function of $t$
	\begin{align*}
		\frac{du}{dt} &= \frac{\partial u}{\partial t} \frac{\partial x}{\partial t} + \frac{\partial u}{\partial y} \frac{\partial y}{\partial t}  \\
	\end{align*}
	...
	\[
	x = t\\
	\therefore \frac{dx}{dt}= 1 \& \frac{dy}{dt} = \frac{dy}{dx}
	.\] 
	Therefore
	\begin{align*}
